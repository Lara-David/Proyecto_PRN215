 ...
 * @author luisd
 */
public class Agregar_Mas_Usuarios extends javax.swing.JFrame {

    public Agregar_Mas_Usuarios() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Desea Agregar Otro Usuario/Admistrador?");
    ...
    //Boton Agregar, permite registrar otro "Usuario/Administrador"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Agregar_Mas_Usuarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Agregar_Mas_Usuarios().setVisible(true);
            }
        });
    }
