 ...
 * @author luisd
 */
public class Agregar_Cancelar extends javax.swing.JFrame {

    public Agregar_Cancelar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Desea Agregar Mas Datos?");
        ...
        jLabel2.setText("Datos de Jefe de Hogar y Vivienda Guardados Con Exito!");
    ...
    //Boton Agregar, permite agregar nuevos datos de "Jefe de Hogar y Vivienda"
    ...
    //Boton Cancelar, nos redirige al formulario principal
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Agregar_Cancelar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Agregar_Cancelar().setVisible(true);
            }
        });
    }
